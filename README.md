...
- Review documents with native [CriticMarkup](docs/CRITICMARKUP.md) support: track changes, suggest edits, add comments and highlights, accept or reject suggestions, and edit or remove annotations from the **Review** menu, sidebar, and in-text controls. Everything is stored as plain markup in your Markdown file.
