...
export default [
  ...
  // 6. JS/MJS/CJS files: keep Babel parser. After the muyajs retirement the
  // only remaining source JS is a couple of assets/symbolIcon files plus this
  // config. Narrow the JS-file scope to prevent stray .js files in the
  // migrated directories from slipping past the TS lint rules.
  {
    files: [
