...
Production Core mode remains blocked on ratified latency evidence, not on a known authority failure. At the rebased product commit `506d45bab802177a5b52cc05e69b70ae77679b4b`, a clean-checkout, one-worker production-transport suite passed all 32 Source and WYSIWYG authority cases in 2.1 minutes with zero retries. It covers caret handoff, Source rebasing, actor history, composition, all five CriticMarkup forms, Review, tab isolation, rejected/stale edits, Worker restart, pending-save ordering, native edits, structural conversion, cross-paragraph replacement and cut, IME, math, and table paste. The exact Playwright JSON transcript is `specs/baselines/runs/core-authority-506d45ba-20260814T214740Z.playwright.json` (SHA-256 `237a955ec75fbec235e0ca3c9b114f67f6f2e359eb2fcd2190a970815acf5933`); the setup/build/test log is adjacent (SHA-256 `0c5410831ebb807201b1ac3cbbb8a2c2542aecbc666c75a94abbd498a122bc6a`). Deterministic recovery cases use the repository test-control bridge, while the separate installed Phase 4 record at the same product commit proves the packaged application path without those controls. Both current-build reruns are green after the upstream rebase.
