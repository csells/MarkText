...
Production Core mode remains blocked on ratified latency evidence and the final release-candidate rerun, not on a known authority failure. At commit `21aaffe4078d49130fb7a7f868a97d52cf68cb87`, a clean-checkout, one-worker production-transport suite passed all 32 Source and WYSIWYG authority cases in 2.0 minutes with zero retries. It covers caret handoff, Source rebasing, actor history, composition, all five CriticMarkup forms, Review, tab isolation, rejected/stale edits, Worker restart, pending-save ordering, native edits, structural conversion, cross-paragraph replacement and cut, IME, math, and table paste. The exact Playwright JSON transcript is `specs/baselines/runs/core-authority-21aaffe4-20260814T212521Z.playwright.json` (SHA-256 `f530e972ae1c02cfc91c87913d6e70f570dd7d8c260b28a52f133bf6edd5b0d5`); the setup/build/test log is adjacent (SHA-256 `89c051be797787829226096c244e52b0f7be87da5d0e9019c8f2222fe2047ef1`). Deterministic recovery cases use the repository test-control bridge, while the separate current-build installed Phase 4 record proves the packaged application path without those controls. Both must be rerun after the final rebase.
