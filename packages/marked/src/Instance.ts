        ...
        pack.extensions.forEach((ext) => {
          ...
          if ('sourceBoundary' in ext) {
            if (extensions.sourceBoundary) {
              extensions.sourceBoundary.unshift(ext.sourceBoundary);
            } else {
              extensions.sourceBoundary = [ext.sourceBoundary];
            }
          }
          if ('initializeTokens' in ext) {
            if (extensions.initializeTokens) {
              extensions.initializeTokens.unshift(ext.initializeTokens);
            } else {
              extensions.initializeTokens = [ext.initializeTokens];
            }
          }
