export const ja = {
    ...
    // tableTools
        ...
        'Remove Row': '行を削除する',
        'Move Row Up': '行を上へ移動する',
        'Move Row Down': '行を下へ移動する',
        // tableColumnTools
        'Align Left': '左揃え',
        'Align Center': '中央揃え',
        'Align Right': '右揃え',
        ...
        'Move Column Left': '列を左へ移動する',
        'Move Column Right': '列を右へ移動する',
        'Clear Alignment': '配置を解除する',
        'Delete Cell Contents': 'セルの内容を削除する',
        'Cut Cells': 'セルを切り取る',
        // quickInsert
        'Paragraph': '一般段落',
