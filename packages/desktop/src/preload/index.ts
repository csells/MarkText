...
const fileUtilsAPI = {
  ...
  copy: (src: string, dest: string, options?: { overwrite: false; errorOnExist: true }) => invoke('mt::fs::copy', src, dest, options),
  ...
  writeFile: (p: string, data: string | Uint8Array, options?: { flag: 'wx' }) => invoke('mt::fs::write-file', p, data, options),
