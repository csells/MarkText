...
export const getCopyAsRich = (): MenuItemConstructorOptions => ({
  ...
  click(_menuItem, targetWindow) {
    if (targetWindow) {
      ;(targetWindow as BrowserWindow).webContents.send('mt::editor-command', 'copy-as-rich')
    }
  }
})
...
export const getCopyAsHtml = (): MenuItemConstructorOptions => ({
  ...
  click(_menuItem, targetWindow) {
    if (targetWindow) {
      ;(targetWindow as BrowserWindow).webContents.send('mt::editor-command', 'copy-as-html')
    }
  }
})
...
export const getPasteAsPlainText = (): MenuItemConstructorOptions => ({
  ...
  click(_menuItem, targetWindow) {
    if (targetWindow) {
      ;(targetWindow as BrowserWindow).webContents.send('mt::editor-command', 'paste-as-plain-text')
    }
  }
})
...
export const getInsertBefore = (): MenuItemConstructorOptions => ({
  ...
  click(_menuItem, targetWindow) {
    if (targetWindow) {
      ;(targetWindow as BrowserWindow).webContents.send('mt::editor-command', 'insert-paragraph-before')
    }
  }
})
...
export const getInsertAfter = (): MenuItemConstructorOptions => ({
  ...
  click(_menuItem, targetWindow) {
    if (targetWindow) {
      ;(targetWindow as BrowserWindow).webContents.send('mt::editor-command', 'insert-paragraph')
    }
  }
})
