...
class Table extends Parent {
    ...
    removeRow(offset: number): Nullable<Content> {
        ...
        // A comment endpoint inside the removed row is handled by the anchor
        // transform at the JSONState choke point: the pair detaches and the
        // thread survives as detached metadata. The edit is never refused.
